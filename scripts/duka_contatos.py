...
TIPO_DA_ESCOLA = {"E.E. Prof. Plínio Ribeiro": "publica", "E.E. Prof. Alcides de Carvalho": "publica", "Colégio Atenas": "particular", "Colégio Santa Teresinha": "particular"}
...
def ler_planilha(caminho=CSV_PADRAO):
    ...
    with Path(caminho).open(encoding="utf-8-sig", newline="") as fh:
        for r in csv.DictReader(fh):
            ...
            escola = ("E.E. Prof. Plínio Ribeiro" if ("plinio" in esc or "normal" in esc) else "E.E. Prof. Alcides de Carvalho" if ("alcides" in esc or "polivalente" in esc) else "Colégio Atenas" if "atenas" in esc else "Colégio Santa Teresinha" if "teresinha" in esc else ("Outra" if esc else "")) if nome else ""
